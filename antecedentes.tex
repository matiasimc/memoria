...
\section{Inferencia con restricciones de subtipos}
Los lenguajes de programación orientados a objetos como Java, Scala y OCaml permiten la definición de nuevos tipos mediante la creación de clases, los cuales se pueden encontrar en una relación de subtipos de forma explícita (nominal) o implícita (estructural).

En una relación de subtipos nominal, el retículo de subtipos es definido explícitamente por el programador o el lenguaje de programación. El ejemplo \ref{ejnominal} muestra una declaración explícita de un retículo de subtipos, mediante el uso del \emph{keyword} \texttt{extends}.
