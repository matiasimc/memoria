\chapter{Inferencia de facetas públicas}

En este trabajo se propone realizar la implementación de un sistema de inferencia de facetas públicas, que incluya el análisis de la desclasificación basada en tipos, y luego la realización de una extensión para ambientes de desarrollo. En este capítulo se detalla el problema de inferencia a resolver y las estrategias utilizadas para resolverlo.
